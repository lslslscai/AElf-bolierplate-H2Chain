...
{
    /// <summary>
    /// The C# implementation of the contract defined in rsu_server_contract.proto that is located in the "protobuf"
    /// folder.
    /// Notice that it inherits from the protobuf generated code. 
    /// </summary>
    public class RSUServerContract : RSUServerContractContainer.RSUServerContractBase
    {
        /// <summary>
